...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: J9r_KaZrHbgy/css

import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: GbP7t3Feybu8/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: LNBq1uBWrECI/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__mv7G5)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__eoKvW)}
              role={"img"}
            />
          ),
